		...
		add_action(
			...
			function () {
				...
				$content .= sprintf(
					...
					esc_html__( 'Allow', 'simple-gdpr-cookie-compliance' )
				);
				...
				$content .= sprintf(
					...
					esc_html__( 'Do not show again', 'simple-gdpr-cookie-compliance' )
				);
				...
				$content .= sprintf(
					...
					esc_html__( 'Later', 'simple-gdpr-cookie-compliance' )
				);
