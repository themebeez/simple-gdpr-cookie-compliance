...
class Simple_GDPR_Cookie_Compliance_Admin_Settings {
	...
	public function register_settings() {
		...
		add_settings_field( 's_gdpr_c_n_styles', 
		...
		add_settings_field( 's_gdpr_c_n_custom_css', 
	...
	public function notice_field() {
		...
		<div class="s_gdpr_c_n_field" id="s_gdpr_c_n_notice_text">
			...
			<div class="s_gdpr_c_n_field_link_content_wrapper <?php echo ( $link_type == 'no_link' ) ? 'sgdpr_hidden' : ''; ?>">
				...
				<p>
					<label for="simple_gdpr_cookie_compliance_options[show_in_new_tab]"><input type="checkbox" id="simple_gdpr_cookie_compliance_options[show_in_new_tab]" name="simple_gdpr_cookie_compliance_options[show_in_new_tab]" class="s_gdpr_c_c_text" value="1" <?php checked( 1, absint( $show_in_new_tab ) ); ?>><?php _e( 'Show link in a new tab', 'simple-gdpr-cookie-compliance' ); ?></label>
				</p>
			</div>
			...
			<p>
				...
				<label for="simple_gdpr_cookie_compliance_options[show_close_btn]"><input type="checkbox" id="simple_gdpr_cookie_compliance_options[show_close_btn]" name="simple_gdpr_cookie_compliance_options[show_close_btn]" class="s_gdpr_c_c_text" <?php checked( $show_close_btn, true ); ?>><?php _e( 'Display Close Button', 'simple-gdpr-cookie-compliance' ); ?></label>				
			</p>

			<p>
				
				<label for="simple_gdpr_cookie_compliance_options[show_cookie_icon]"><input type="checkbox" id="simple_gdpr_cookie_compliance_options[show_cookie_icon]" name="simple_gdpr_cookie_compliance_options[show_cookie_icon]" class="s_gdpr_c_c_text" <?php checked( $show_cookie_icon, true ); ?>><?php _e( 'Display Cookie Icon', 'simple-gdpr-cookie-compliance' ); ?></label>				
			</p>
		</div>
		<?php
	}
	...
	public function style_fields() {
		...
		$type = ! empty( $this->options['style']['type'] ) ? $this->options['style']['type'] : 'custom_width';

		$width = ! empty( $this->options['style']['width'] ) ? $this->options['style']['width'] : 450;

		$fullwidth_position =  ! empty( $this->options['style']['fullwidth_position'] ) ? $this->options['style']['fullwidth_position'] : 'top';

		$customwidth_position =  ! empty( $this->options['style']['customwidth_position'] ) ? $this->options['style']['customwidth_position'] : 'bottom_right';

		$enable_bg_overlay = isset( $this->options['style']['enable_bg_overlay'] ) ? $this->options['style']['enable_bg_overlay'] : true;

		$top_offset = ! empty( $this->options['style']['top_offset'] ) ? $this->options['style']['top_offset'] : 30;

		$left_offset = ! empty( $this->options['style']['left_offset'] ) ? $this->options['style']['left_offset'] : 30;

		$bottom_offset = ! empty( $this->options['style']['bottom_offset'] ) ? $this->options['style']['bottom_offset'] : 30;

		$right_offset = ! empty( $this->options['style']['right_offset'] ) ? $this->options['style']['right_offset'] : 30;
		?>
		<div class="s_gdpr_c_n_field" id="s_gdpr_c_n_style">
			<p>
				<label for="simple_gdpr_cookie_compliance_options[style][type]"><?php echo __( 'Width Style', 'simple-gdpr-cookie-compliance' ); ?></label>
				<?php
				$styles = array(
					'full_width' => __( 'Full Width', 'simple-gdpr-cookie-compliance' ),
					'custom_width' => __( 'Custom Width', 'simple-gdpr-cookie-compliance' ),
					'pop_up' => __( 'Pop Up', 'simple-gdpr-cookie-compliance' )
				);
				?>
			...
			<p id="s_gdpr_c_n_width" class="<?php echo ( $type == 'full_width' ) ? 'sgdpr_hidden' : ''; ?>">
				<label for="simple_gdpr_cookie_compliance_options[style][width]"><?php echo __( 'Width', 'simple-gdpr-cookie-compliance' ); ?></label>
			...
			<p id="s_gdpr_c_n_fullwidth_position" class="<?php echo ( $type == 'full_width' ) ? '' : 'sgdpr_hidden'; ?>">
				<label for="simple_gdpr_cookie_compliance_options[style][fullwidth_position]"><?php echo __( 'Position', 'simple-gdpr-cookie-compliance' ); ?></label>
				<?php
				$styles = array(
			...
			<p id="s_gdpr_c_n_customwidth_position" class="<?php echo ( $type != 'custom_width' ) ? 'sgdpr_hidden' : ''; ?>">
				<label for="simple_gdpr_cookie_compliance_options[style][customwidth_position]"><?php echo __( 'Position', 'simple-gdpr-cookie-compliance' ); ?></label>
				<?php
				$styles = array(
			...
			<p id="s_gdpr_c_n_enable_bg_overlay" class="s_gdpr_c_n_checkbox_field <?php echo ( $type != 'pop_up' ) ? 'sgdpr_hidden' : ''; ?>">
				<label for="simple_gdpr_cookie_compliance_options[style][enable_bg_overlay]"><input type="checkbox" class="s_gdpr_c_n_bg_overlay_field" name="simple_gdpr_cookie_compliance_options[style][enable_bg_overlay]" id="simple_gdpr_cookie_compliance_options[style][enable_bg_overlay]" <?php checked( true, $enable_bg_overlay ); ?>><?php echo __( 'Enable Background Overlay', 'simple-gdpr-cookie-compliance' ); ?></label>

			</p>

			<div id="s_gdpr_c_n_offset_group_wrapper" class="s_gdpr_c_n_group_wrapper <?php echo ( $type != 'custom_width' ) ? 'sgdpr_hidden' : ''; ?>">
	...
	public function color_fields() {
		...
		$notice_bg_overlay_color = ! empty( $this->options['color']['notice_bg_overlay_color'] ) ? $this->options['color']['notice_bg_overlay_color'] : 'rgba(0,0,0,0.8)';

		$enable_bg_overlay = ! empty( $this->options['style']['enable_bg_overlay'] ) ? $this->options['style']['enable_bg_overlay'] : true;
		...
		<div class="s_gdpr_c_n_field s_gdpr_c_n_color_options_field" id="s_gdpr_c_n_link">
			...
			<div class="s_gdpr_c_n_group_wrapper <?php echo ( $enable_bg_overlay == true && $type == 'pop_up' ) ? '' : 'sgdpr_hidden'; ?>" id="s_gdpr_c_n_bg_overlay">
				<h4 class="s_grpd_c_n_group_title"><?php echo __( 'Overlay Color', 'simple-gdpr-cookie-compliance' ); ?></h4>
				<div class="s_gdpr_c_n_group">
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_bg_overlay_color]"><?php echo __( 'Background', 'simple-gdpr-cookie-compliance' ); ?></label>
			...
			<div class="s_gdpr_c_n_group_wrapper">
				<h4 class="s_grpd_c_n_group_title"><?php echo __( 'Notice Color', 'simple-gdpr-cookie-compliance' ); ?></h4>
				<div class="s_gdpr_c_n_group">
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_background]"><?php echo __( 'Background', 'simple-gdpr-cookie-compliance' ); ?></label>
					...
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_cookie_icon_color]"><?php echo __( 'Cookie Icon', 'simple-gdpr-cookie-compliance' ); ?></label>
					...
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_text]"><?php _e( 'Text', 'simple-gdpr-cookie-compliance' ); ?></label>
					...
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_link_color]"><?php echo __( 'Link', 'simple-gdpr-cookie-compliance' ); ?></label>
					...
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_link_hover_color]"><?php echo __( 'Link - On Hover', 'simple-gdpr-cookie-compliance' ); ?></label>
			...
			<div class="s_gdpr_c_n_group_wrapper">
				<h4 class="s_grpd_c_n_group_title"><?php echo __( 'Close Button Color', 'simple-gdpr-cookie-compliance' ); ?></h4>
				<div class="s_gdpr_c_n_group">
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_box_close_btn_bg_color]"><?php echo __( 'Background', 'simple-gdpr-cookie-compliance' ); ?></label>
					...
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_box_close_btn_bg_hover_color]"><?php echo __( 'Background - On Hover', 'simple-gdpr-cookie-compliance' ); ?></label>
					...
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_box_close_btn_text_color]"><?php echo __( 'Text', 'simple-gdpr-cookie-compliance' ); ?></label>
					...
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_box_close_btn_hover_text_color]"><?php echo __( 'Text - On Hover', 'simple-gdpr-cookie-compliance' ); ?></label>
			...
			<div class="s_gdpr_c_n_group_wrapper">
				<h4 class="s_grpd_c_n_group_title"><?php echo __( 'Accept Button Color', 'simple-gdpr-cookie-compliance' ); ?></h4>
				<div class="s_gdpr_c_n_group">
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_compliance_button_bg]"><?php echo __( 'Background', 'simple-gdpr-cookie-compliance' ); ?></label>
					...
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_compliance_button_hover_bg_color]"><?php echo __( 'Background - On Hover', 'simple-gdpr-cookie-compliance' ); ?></label>
					...
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_compliance_button_border_color]"><?php echo __( 'Border', 'simple-gdpr-cookie-compliance' ); ?></label>
					...
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_compliance_button_hover_border_color]"><?php echo __( 'Border - On Hover', 'simple-gdpr-cookie-compliance' ); ?></label>
					...
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_compliance_button_text_color]"><?php echo __( 'Text', 'simple-gdpr-cookie-compliance' ); ?></label>
					...
					<div class="s_gdpr_c_n_group_field">
						<label for="simple_gdpr_cookie_compliance_options[color][notice_compliance_button_hover_text_color]"><?php echo __( 'Text - On Hover', 'simple-gdpr-cookie-compliance' ); ?></label>
