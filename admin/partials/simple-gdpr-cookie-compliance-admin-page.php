	...
	<div class="sgcc-inner-entry content-main">
		<section class="sgcc-welcome-section sgcc-white-bg sgcc-section-spacing">
			<div class="sgcc-plugin-title">
				<h2><?php echo esc_html__( 'Simple GDPR Cookie Compliance', 'simple-gdpr-cookie-compliance' ); ?></h2>
			</div><!-- .sgcc-plugin-title -->
			<div class="sgcc-plugin-intro">
				<p><?php echo esc_html__( 'Simple GDPR Cookie Compliance is a simple and minimal WordPress plugin that helps you become GDPR compliant and notify users about your website&rsquo;s cookie policy or privacy policy. This plugin adds a small notice box at the bottom of right side of your website. You can easily set notify message as well as customize your notice with color options.', 'simple-gdpr-cookie-compliance' ); ?></p>
